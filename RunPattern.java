...
public class RunPattern {
    public static void main(String[] arguments) {
        ...
        System.out.println("Moving through the Project, calculating total cost");
        ...
        // ✅ Новий функціонал для систем мір
        System.out.println("\n=== Перетворення одиниць вимірювання ===");
        UnitConversionVisitor unitVisitor = new UnitConversionVisitor();
        visitProjectItems(project, unitVisitor);
    }
