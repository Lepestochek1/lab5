...
public class Deliverable implements ProjectItem {
    ...
    // ✅ Нові поля
    private double weightKg; // маса в кілограмах
    private double lengthM;  // довжина в метрах

    public Deliverable() {}

    public Deliverable(String newName, String newDescription,
                       Contact newOwner, double newMaterialsCost,
    ...
    public void setLengthM(double l) { lengthM = l; }
